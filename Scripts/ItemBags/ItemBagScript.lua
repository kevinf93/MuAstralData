...
-- Bags by Kevin Fernandez - Goldens
	...
	AddItemBag(BAG_MONSTER, 0, 54, 'zGMonster_(54)_Golden_Soldier');
	AddItemBag(BAG_MONSTER, 0, 78, 'zGMonster_(78)_Golden_Goblin');
	AddItemBag(BAG_MONSTER, 0, 79, 'zGMonster_(79)_Golden_Derkon_Dragon');
	AddItemBag(BAG_MONSTER, 0, 80, 'zGMonster_(80)_Golden_Lizard_King');
	AddItemBag(BAG_MONSTER, 0, 81, 'zGMonster_(81)_Golden_Vepar');
	AddItemBag(BAG_MONSTER, 0, 82, 'zGMonster_(82)_Golden_Tantalos');
	AddItemBag(BAG_MONSTER, 0, 83, 'zGMonster_(83)_Golden_Wheel');
	AddItemBag(BAG_MONSTER, 0, 493, 'zGMonster_(493)_Golden_Dark_King');
	AddItemBag(BAG_MONSTER, 0, 494, 'zGMonster_(494)_Golden_Devil');
	AddItemBag(BAG_MONSTER, 0, 495, 'zGMonster_(495)_Golden_Stone_Golem');
	AddItemBag(BAG_MONSTER, 0, 496, 'zGMonster_(496)_Golden_Mega_Crust');
	AddItemBag(BAG_MONSTER, 0, 497, 'zGMonster_(497)_Golden_Satyros');
	AddItemBag(BAG_MONSTER, 0, 498, 'zGMonster_(498)_Golden_Twin_Tail');
	AddItemBag(BAG_MONSTER, 0, 499, 'zGMonster_(499)_Golden_Iron_Knight');
	AddItemBag(BAG_MONSTER, 0, 500, 'zGMonster_(500)_Golden_Napin');
	AddItemBag(BAG_MONSTER, 0, 501, 'zGMonster_(501)_Golden_Great_Dragon');
	AddItemBag(BAG_MONSTER, 0, 502, 'zGMonster_(502)_Golden_Rabbit');
	AddItemBag(BAG_MONSTER, 0, 652, 'zGMonster_(652)_Golden_Goblin_Rage');
	AddItemBag(BAG_MONSTER, 0, 653, 'zGMonster_(653)_Golden_Titan_Rage');
	AddItemBag(BAG_MONSTER, 0, 654, 'zGMonster_(654)_Golden_Tantalos_Rage');
	AddItemBag(BAG_MONSTER, 0, 655, 'zGMonster_(655)_Golden_Erohim');
	AddItemBag(BAG_MONSTER, 0, 656, 'zGMonster_(656)_Golden_Hell_Maine');
	AddItemBag(BAG_MONSTER, 0, 657, 'zGMonster_(657)_Golden_Kundun');
-- Bags by Kevin Fernandez - Normales
	AddItemBag(BAG_MONSTER, 0, 161, 'zMonster_(161)_Kundun1');
	AddItemBag(BAG_MONSTER, 0, 181, 'zMonster_(181)_Kundun2');
	AddItemBag(BAG_MONSTER, 0, 189, 'zMonster_(189)_Kundun3');
